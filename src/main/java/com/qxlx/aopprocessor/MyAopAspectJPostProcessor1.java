 ...
 */
//@Component
public class MyAopAspectJPostProcessor1 implements BeanPostProcessor, BeanFactoryPostProcessor {
...
//        final MethodBeforeAdvice methodBeforeAdvice = beanFactory.getBean(MethodBeforeAdvice.class);
        ...
        return Proxy.newProxyInstance(MyAopAspectJPostProcessor1.class.getClassLoader(), bean.getClass().getInterfaces(), new InvocationHandler() {
            @Override
            public Object invoke(Object o, Method method, Object[] objects) throws Throwable {
                ...
                if (pointcutAdvisor.getPointcut().getClassFilter().matches(bean.getClass())) {
                    ...
                    if (pointcutAdvisor.getAdvice() instanceof AfterReturningAdvice) {
                        ((AfterReturningAdvice) pointcutAdvisor.getAdvice()).afterReturning(ret, method, objects, bean);
                    }
                    return ret;
                }
                return method.invoke(bean, objects);
